 ...
 * that was asked in the thread. Drawing one instead happens through the
 * composer's own palette button, as a turn in the conversation — not
 * duplicated here as a second draw form.
 */
