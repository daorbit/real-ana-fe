  ...
  return (
    <>
      ...
      {/* Always on screen, open or closed. Hiding it while the panel was up
          ...
          around a green disc. */}
      {/* No tooltip: the mark is the same one used across the app, and a label
          that follows the cursor over a floating button is in the way more
          often than it is read. `aria-label` still names the control for
          screen readers, which is the part that has to stay. */}
      <UnstyledButton
        className="orbit-fab"
